...
?>
    <h1 class="mb-4 text-center text-primary text-uppercase ">Todo List</h1>
            ...
            <div class="accordion-item mb-2">
                <div class="accordion-header d-flex justify-content-between align-items-center row"
                    ...
                    <h2 class="accordion-header">
                        <button style="background: <?= $priorityColor ?>;" class="accordion-button collapsed"
                                type="button"
