    ...
    <main>
        <div class="container">
            <div class="row">
                ...
                $topic = select('topics', ['id' => $_GET['id']]) ?>
                <div class="topics col-9">
                    ...
                    <div class="row add-post">
                        <form action="edit.php?id=<?= $topic[0]['id'] ?>" method="post">
                            <input name="id" type="hidden" value="<?= $topic[0]['id'] ?>">
                            <div class="col">
                                <input name="name" type="text" class="form-control" placeholder="Category Name"
                                       aria-label="Category name" value="<?= $topic[0]['name'] ?>">
                            </div>
                            <div class="col textarea-category">
                                <label for="content" class="form-label"></label>
                                <textarea name="description" class="form-control" rows="3"
                                          placeholder="Category description"><?= $topic[0]['description'] ?></textarea>
                            </div>
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary" name="topic_edit">Edit Category</button>
                            </div>
                        </form>
                    </div>
                </div>
